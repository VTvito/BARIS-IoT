...
if __name__ == '__main__':
    br = Bridge()
    br.setup()
    cred = credentials.Certificate("C:/Users/vitod/Desktop/BARIS IoT/Python/bridge_prototype/baris-iot-vito-firebase-adminsdk-baww0-f6eece4154.json")   # credenziali di firestore
